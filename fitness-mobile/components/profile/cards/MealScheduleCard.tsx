  ...
  return (
    <Animated.View entering={FadeInDown.duration(240)} style={{ gap: 16 }}>
      ...
      <Text style={{ color: colors.muted }}>
        Consistent timing helps hunger control and energy.
      </Text>
      ...
      >
        ...
        <Text style={{ color: colors.muted }}>
          Currently: {props.mealsPerDay}
        </Text>
      </View>

      <View style={{ flexDirection: "row", gap: 12 }}>
        <TimeCard label="First meal" value={props.breakfastTime} />
        <TimeCard label="Last meal" value={props.lastMealTime} />
      </View>

      <Text style={{ fontSize: 12, color: colors.muted }}>
        You don’t need perfect timing — consistency matters more.
      </Text>
    </Animated.View>
  );
}
