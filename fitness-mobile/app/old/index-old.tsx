...
export default function HomeScreen() {
    ...
    () => [
      {
        ...
        label: "Calorie quest",
        progress: Math.min(1, totals.calories / Math.max(1, kcalGoal || 1)),
        detail:
  ...
  useEffect(() => {
    ...
    // If Pro is locked, show an upgrade-friendly card and bail.
    if (!isPro) {
      setSuggestion({
        icon: "sparkles-outline",
        title: "Unlock AI suggestions",
        body: "Get daily personalized coaching tips, recovery nudges, and macro-aware plans.",
        ctaLabel: "See Pro",
        href: "/paywall" as Href,
        tint: "ok",
      });
      return;
    }
  ...
  return (
    ...
    >
      ...
      {!isPro && (
        ...
        >
          <LinearGradient
            colors={[withAlpha(arcadeColors.neonPink, 0.25), colors.card]}
            start={{ x: 0, y: 0 }}
            end={{ x: 1, y: 1 }}
            style={{
              borderRadius: 18,
          ...
          >
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  Go Pro for AI superpowers
                </Text>
                <Text style={{ color: colors.muted, marginTop: 4 }}>
                  Unlock Coach Spark, AI meals, describe exercises, templates,
                  and home AI tips.
                </Text>
              </View>
            </View>
        ...
        >
          <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
            ...
            <View>
              ...
              <Text style={{ color: withAlpha(colors.text, 0.7) }}>
                {detail}
              </Text>
            </View>
          </View>
